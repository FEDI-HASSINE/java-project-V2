    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/demandes/*/interventions").hasAuthority("responsable_municipalite")
                .requestMatchers(HttpMethod.POST, "/demandes/*/notifications").hasAuthority("responsable_municipalite")
                .requestMatchers(HttpMethod.POST, "/equipements").hasAuthority("responsable_municipalite")
                .requestMatchers(HttpMethod.GET, "/equipements").hasAnyAuthority("responsable_municipalite", "chef")
                .requestMatchers(HttpMethod.GET, "/interventions/*/equipements").hasAuthority("responsable_municipalite")
                .requestMatchers(HttpMethod.POST, "/interventions/*/equipements").hasAuthority("responsable_municipalite")
                .requestMatchers(HttpMethod.POST, "/interventions/*/update").hasAuthority("responsable_municipalite")
                ...
                .requestMatchers(HttpMethod.GET, "/agents").hasAnyAuthority("chefinfo", "responsable_municipalite", "chef")
