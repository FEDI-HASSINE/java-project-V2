...
def main():
    ...
    eq1 = create_equipement(token, "TestEquipA")
    print(f"Created equip 1: {eq1['id']}")
    eq2 = create_equipement(token, "TestEquipB")
    print(f"Created equip 2: {eq2['id']}")
    ...
    # Assign second
    assign_equipement(token, intervention_id, eq2['id'])
